...
if __name__ == "__main__":            
    ...
    test_multiprocessing(CustomEnv, CustomAgent, test_df, test_df_nomalized, num_worker = 32, visualize=True, test_episodes=1000, folder="2021_02_21_17_54_Crypto_trader", name="3447.20_Crypto_trader", comment="3 months")
